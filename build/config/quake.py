...
mastery = [True, True, False, False, False] # Elemental masteries from skilltree [ETWFA]
...
rel_ids = ['walkSpeed','manaRegen','manaSteal']
...
class DmgConfig(OptimizerConfig):
    ...
    def __init__(self):
        ...
        self.set_identification_min("walkSpeed", 40)
